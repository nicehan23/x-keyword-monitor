...
- **자동 포스팅**: 하루 4회 자동 포스팅 (08:00, 17:00, 18:00, 20:00 KST)
- **인게이지먼트 추적**: RT, 좋아요, 조회수 등 자동 수집 (매일 07:30)
- **대시보드**: 생성 내역, 인게이지먼트, 주간 Top 5 확인
...
온라인: [대시보드 바로가기](https://nicehan23.github.io/x-keyword-monitor/tweet-dashboard.html)

로컬: 브라우저에서 `file:///Users/[사용자명]/x-keyword-monitor/tweet-dashboard.html`
